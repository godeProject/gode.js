...
function convert(message) {
    ...
    while (i < messageLength) {
        if (messageArray[i] === ',') {
            if (qwerty.includes(messageArray[i - 1])) {
                ans.push(kedmanee[qwerty.indexOf(messageArray[i])]);
            }
            else if (kedmanee.includes(messageArray[i - 1])) {
                ans.push(qwerty[kedmanee.indexOf(messageArray[i])]);
            }
            else {
                ans.push(kedmanee[qwerty.indexOf(messageArray[i])]);
            }
            ...
            if (kedmanee.includes(messageArray[i - 1])) {
                ans.push(qwerty[kedmanee.indexOf(messageArray[i])]);
            }
            else if (qwerty.includes(messageArray[i - 1])) {
                ans.push(kedmanee[qwerty.indexOf(messageArray[i])]);
            }
            else {
                ans.push(kedmanee[qwerty.indexOf(messageArray[i])]);
        ...
        else if (kedmanee.includes(messageArray[i])) {
            ans.push(qwerty[kedmanee.indexOf(messageArray[i])]);
        }
        else if (qwerty.includes(messageArray[i])) {
            ans.push(kedmanee[qwerty.indexOf(messageArray[i])]);
        }
        else if (messageArray[i] === " ") {
            ans.push(" ");
